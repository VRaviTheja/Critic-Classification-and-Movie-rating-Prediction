# -*- coding: utf-8 -*-
"""
Created on Mon May  7 20:49:28 2018

@author: Ravi Theja
"""

tf_idf_sample = vectorizer.transform(sample)
...
nn_input_dim = len(X[1]) # input layer dimensionality 
...
accu = model1.score(test_corpus_tf_idf, y_test)
